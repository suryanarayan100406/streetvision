    ...
    validFeatures.forEach((feature) => {
      ...
      marker.bindPopup(`
        <div style="min-width:220px;font-family:Arial,sans-serif;line-height:1.45">
          <div style="font-size:15px;font-weight:700;margin-bottom:6px">Pothole #${props.id ?? 'Unknown'}</div>
          <div><strong>Severity:</strong> ${props.severity || 'Unknown'}</div>
          <div><strong>Risk:</strong> ${Number(props.risk_score || 0).toFixed(1)}/100</div>
